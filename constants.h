...
namespace ts
{
  ...
  const int ITEM_AFFECT_SPELLPOWER        = 65;
  /* Item Applies End */
  ...
  const int ROOM_TELEPORT_FLAG_NOEXIT = 4;
  ...
  const int EXIT_FLAG_RSLOCKED  = 4;
  ...
  const int CHARACTER_RACE_INANIMATE = 90;
  const int CHARACTER_RACE_END             = 91;
  /* Races End */
  ...
  const int CHARACTER_CLASS_END         = 12;
  ...
  const int AFFECT2_CON_ORDER          = 5;
  const int AFFECT2_AFK                = 6;
